...
# from mydiff_mlp import DiffuRec 
# from mydiff_wo_temb import DiffuRec 
# from mydiff_wo_seq import DiffuRec
...
class Att_Diffuse_model(nn.Module):
    ...
    def diffu_pre(self, item_rep, target_beha_rep, tag_emb, mask_seq, tag_beha_idx):
        ...
        # seq_rep_diffu, item_rep_out, weights, t  = self.diffu(item_rep, target_beha_rep, tag_emb, mask_seq)
    ...
    def reverse(self, item_rep, target_beha_pre, noise_x_t, mask_seq, tag_beha_idx):
        ...
        # reverse_pre = self.diffu.reverse_p_sample(item_rep, target_beha_pre, noise_x_t, mask_seq)
        
        # TODO for UB 这个效果太差
        # reverse_pre -= self.beha_embeddings(tag_beha_idx)
        return reverse_pre
    ...
    # TODO 同 trainer_aug.py 中的CELoss
    ...
    # TODO 同 trainer_aug.py 中的caluculate_all_item_prob
